    ...
    <div class="container-fluid">
        <div class="col-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <form id="form" method="post" action="{{route('marks.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div id="app-msgs">
                            @if (session('status'))
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="maths" class="form-control" placeholder="Enter maths mark">
                                    @if ($errors->has('maths'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="science" class="form-control" placeholder="Enter science mark">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="history" class="form-control" placeholder="Enter history mark">
